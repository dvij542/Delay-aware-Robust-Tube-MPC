...
traj_without_comp = np.loadtxt('trajectory_with_comp.csv')
traj_with_comp = np.loadtxt('trajectory_with_comp.csv')
traj_opp_without_comp = np.loadtxt('trajectory_opp_with_comp.csv')
traj_opp_with_comp = np.loadtxt('trajectory_opp_with_comp.csv')

traj_with_comp[:,0] = traj_with_comp[0,0] + (traj_with_comp[:,0] - traj_with_comp[0,0])*2
traj_opp_with_comp[:,0] = traj_opp_with_comp[0,0] + (traj_opp_with_comp[:,0] - traj_opp_with_comp[0,0])*2.5
with_i = 0
